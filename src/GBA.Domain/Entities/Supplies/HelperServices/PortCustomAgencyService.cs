...
public sealed class PortCustomAgencyService : BaseService {
    public PortCustomAgencyService() {
    ...
    public long? PortCustomAgencyOrganizationId { get; set; }

    public SupplyOrganization PortCustomAgencyOrganization { get; set; }
