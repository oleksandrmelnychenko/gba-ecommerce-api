...
public sealed class AddNewProductIncomeFromSupplyOrderUkraineDynamicPlacementsMessage {
    public AddNewProductIncomeFromSupplyOrderUkraineDynamicPlacementsMessage(
