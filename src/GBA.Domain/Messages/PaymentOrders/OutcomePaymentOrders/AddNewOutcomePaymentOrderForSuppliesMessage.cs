...
public sealed class AddNewOutcomePaymentOrderForSuppliesMessage {
    public AddNewOutcomePaymentOrderForSuppliesMessage(OutcomePaymentOrder outcomePaymentOrder, Guid currentuserNetId) {
