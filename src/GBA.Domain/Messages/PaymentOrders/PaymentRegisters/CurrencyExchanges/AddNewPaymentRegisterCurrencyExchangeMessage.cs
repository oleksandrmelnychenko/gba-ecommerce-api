...
public sealed class AddNewPaymentRegisterCurrencyExchangeMessage {
    public AddNewPaymentRegisterCurrencyExchangeMessage(PaymentRegisterCurrencyExchange paymentRegisterCurrencyExchange, Guid userNetId) {
