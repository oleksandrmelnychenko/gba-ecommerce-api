...
public sealed class UpdatePaymentRegisterTransferMessage {
    public UpdatePaymentRegisterTransferMessage(PaymentRegisterTransfer paymentRegisterTransfer, Guid userNetId) {
