...
public sealed class GetAccountingCashFlowInfoMessage {
    public GetAccountingCashFlowInfoMessage(Guid netId, DateTime from, DateTime to, TypePaymentTask typePaymentTask) {
        NetId = netId;
