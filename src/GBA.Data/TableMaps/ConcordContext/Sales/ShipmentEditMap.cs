...
public sealed class ShipmentEditMap : EntityBaseMap<WarehousesShipment> {
    public override void Map(EntityTypeBuilder<WarehousesShipment> entity) {
        base.Map(entity);

        entity.ToTable("WarehousesShipment");

        //entity.Property(e => e.SaleId).HasColumnName("UserId");
